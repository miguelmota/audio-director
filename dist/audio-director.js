...
},{"./constants/PlayerEventTypes":2,"arraybuffer-to-audiobuffer":5,"d3-scale":11,"eventemitter2":14,"random-int":21}],4:[function(require,module,exports){
const EventEmitter2 = require('eventemitter2').EventEmitter2
const qs = require('qs')
const {scaleLinear} = require('d3-scale')
...
},{"./constants/PlayerEventTypes":2,"d3-scale":11,"eventemitter2":14,"qs":17}],5:[function(require,module,exports){
;(function(root) {
  'use strict';
